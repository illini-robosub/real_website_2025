...
const docList = [
    {
        ...
        DocText: "The summer of 2025 saw Illini RoboSub make massive strides toward being competition ready. Over the past year, our team has successfully demonstrated instances of controlled underwater movement and full autonomous navigation. As a result, we feel optimistic in our robot, 'Box,' to be ready for RoboSub 2026. Upon competition, a handful of members will accompany Box to Irvine California to ensure its ready for competition and answer questions about its development process.",
        Date: "SUMMER 2025",
    },
    {
        Name: "Hakko",
